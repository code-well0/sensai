            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <TrendingUp className="h-4 w-4 texted-muted-foreground" />
                    </CardHeader>
                    <CardContent>
                        <div className="text-2xl font-bold">
                            {insights.growthRates.toFixed(1)}%
                        </div>
                        <Progress value={insights.growthRates} className="mt-2" />
                    </CardContent>
                </Card>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <BriefcaseIcon className="h-4 w-4 texted-muted-foreground" />
                    </CardHeader>
                    <CardContent>
                ...
                <Card>
                    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                        ...
                        <Brain className="h-4 w-4 texted-muted-foreground" />
                    </CardHeader>
                    <CardContent>
